...
def _(self: web_server_handler) -> bool:
    '''
    Called by the player routine before launching a v554 client.
...
@server_path('/users/account-info', versions={versions.rōblox.v554})
def _(self: web_server_handler) -> bool:
    '''
    RBLXHUB-style account bootstrap endpoint.
    Used by the 2022L studio client when fetching critical settings.
    '''
    self.send_json({
        "UserId": 21,
        "Username": "test",
...
@server_path('/v1/authentication-ticket/redeem', versions={versions.rōblox.v554})
def _(self: web_server_handler) -> bool:
    '''
    2022L authentication-ticket redeem stub.
...
@server_path('/v2/settings/application/PCDesktopClient', versions={versions.rōblox.v554})
def _(self: web_server_handler) -> bool:
    '''
