...
def _(self: web_server_handler) -> bool:
    ...
    self.send_json({
        ...
        'ApiProxyDomain': 'https://api.rbolock.tk',
        'AccountSettingsApiDomain': 'http://api.rbolock.tk',
        'AuthDomain': 'http://api.rbolock.tk',
        'IsDisconnectFacebookEnabled': True,
        'IsDisconnectXboxEnabled': True,
        'NotificationSettingsDomain': 'https://notifications.rbolock.tk',
        ...
        'LocaleApiDomain': 'https://locale.rbolock.tk',
